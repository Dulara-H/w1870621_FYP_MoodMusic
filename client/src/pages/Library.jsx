...
// Library page - displays user's saved playlists with management features
export const Library = () => {
  ...
  // Enable edit mode for playlist name
...
// Play first song of playlist with all songs in queue
...
// Gradient colors for playlist cover backgrounds
const gradients = [
...
return (
  <div className="min-h-screen bg-[#121212] text-white font-sans">
    ...
    >
      ...
      {/* Playlists grid or loading state */}
      {loading ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          ...
          {filteredPlaylists.map((playlist, index) => (
            ...
            >
              {/* Gradient background for playlist cover */}
              <div
